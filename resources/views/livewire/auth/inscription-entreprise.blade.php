    ...
    <div class="w-full max-w-2xl">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 text-sm mt-1">
                Inscrivez votre entreprise au Business Forum CCI-BF
            </p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <h3 class="text-2xl font-bold text-gray-800 mb-3">
                Dossier entreprise envoyé !
            </h3>
            <p class="text-gray-600 mb-4">
                Votre entreprise a été préenregistrée avec succès.
                L'équipe CCI-BF va traiter votre demande.
            </p>
        ...
        <div class="flex items-center mb-6">
            @foreach([1 => 'Entreprise', 2 => 'Représentant', 3 => 'Confirmation'] as $num => $label)
            ...
            <div class="p-8">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input wire:model="secteur_autre" type="text"
            ...
            <div class="p-8">
                ...
                <div class="space-y-3 mb-6">
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-4 text-sm text-yellow-700">
                        ...
                        Votre dossier sera examiné par l'administration CCI-BF.
                        Vous serez contacté après validation.
                    </div>
                </div>
