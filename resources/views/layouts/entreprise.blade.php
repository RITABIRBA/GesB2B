...
<head>
    ...
    <title>{{ $title ?? 'GesB2B' }} — Entreprise</title>
...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-64 flex flex-col shadow-xl flex-shrink-0"
        ...
        <div class="p-6 text-center border-b border-green-800">
            <div class="flex items-center justify-center gap-2 mb-1">
                <div class="w-8 h-8 rounded-full flex items-center justify-center text-white font-bold text-sm"
                    style="background-color: #C8102E;">E</div>
                <h1 class="text-xl font-bold text-white">GesB2B</h1>
            </div>
            <p class="text-xs text-green-300 mt-1">Espace Entreprise</p>
        </div>
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
            @php
            $navItems = [
                ['route' => 'entreprise.dashboard',    'icon' => 'fa-gauge',        'label' => 'Dashboard'],
                ['route' => 'entreprise.profil',       'icon' => 'fa-building',     'label' => 'Mon Profil'],
                ['route' => 'entreprise.participants', 'icon' => 'fa-users',        'label' => 'Mes Participants'],
                ['route' => 'entreprise.stands',       'icon' => 'fa-store',        'label' => 'Mes Stands'],
                ['route' => 'entreprise.souhaits',     'icon' => 'fa-heart',        'label' => 'Souhaits RDV'],
                ['route' => 'entreprise.rendez-vous',  'icon' => 'fa-handshake',    'label' => 'Rendez-vous'],
                ['route' => 'entreprise.catalogue',    'icon' => 'fa-book-open',    'label' => 'Catalogue'],
            ];
            @endphp
        ...
        <div class="p-4 border-t border-green-800">
            <div class="flex items-center gap-3 px-3 py-2 mb-2">
                ...
                <div>
                    ...
                    <p class="text-green-300 text-xs">Entreprise</p>
                </div>
            </div>
