<div>
    ...
    <div id="planning-print">
        ...
        {{-- En-tête du planning (visible à l'impression) --}}
        <div class="bg-white rounded-xl shadow p-6 mb-6 print-header">
        ...
        {{-- Grouper par date --}}
        @php
            $rdvParDate = $rendezVous->groupBy('date');
        @endphp
            ...
            <div class="space-y-3">
                ...
                <div class="bg-white rounded-xl shadow p-5 flex items-center gap-5 hover:shadow-lg transition">
                    ...
                    <div class="text-center flex-shrink-0 w-20">
                        ...
                        <p class="text-xs text-gray-400 mt-1">Stand</p>
                    </div>
