                ...
                <tr>
                    <td colspan="5" class="py-16 text-center text-gray-400">
                        ...
                        <div class="flex justify-center gap-3 mt-3">
                            <button wire:click="genererTousBadges"
                                wire:confirm="Générer les badges pour tous les participants ?"
                                class="px-5 py-2 rounded-xl text-white text-sm font-medium bg-blue-600">
                ...
                <div class="grid grid-cols-1 gap-5">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            ...
                            <button wire:click="regenererQrCode"
                                type="button"
                        ...
                        <p class="text-xs text-gray-400 mt-1.5 flex items-center gap-1">
                            ...
                            Cliquez sur <i class="fa-solid fa-arrows-rotate mx-1"></i> pour régénérer.
                        </p>
                    </div>
