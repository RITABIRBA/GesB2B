    ...
    <div class="bg-white rounded-xl shadow overflow-x-auto">
        <table class="w-full text-left">
            ...
            <tbody>
                ...
                @php $rep = $entreprise->participants->where('role', 'representant')->first(); @endphp
                <tr class="border-b hover:bg-gray-50 transition">
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                @if($entreprise->ifu)
                                <span class="font-mono text-xs text-gray-400">{{ $entreprise->ifu }}</span>
                                @endif
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4 text-sm">
                        @if($rep)
                        <p class="font-medium text-gray-700">{{ $rep->nom }} {{ $rep->prenom }}</p>
                        <p class="text-xs text-gray-400">{{ $rep->telephone }}</p>
                        @else
                        <span class="text-gray-400 italic text-xs">Aucun représentant</span>
                        @endif
                    </td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex gap-2 flex-wrap">
                            ...
                            <button wire:click="rejeter({{ $entreprise->id }})"
                                wire:confirm="Rejeter cette entreprise ?"
    ...
    <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md">
            <div class="px-8 py-6 rounded-t-2xl text-white text-center"
                ...
                <h3 class="text-xl font-bold">Entreprise créée !</h3>
                <p class="text-green-200 text-sm mt-1">Compte représentant généré</p>
            </div>
            <div class="p-8">
                <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-3 mb-4 text-xs text-yellow-700">
                    <i class="fa-solid fa-triangle-exclamation mr-1"></i>
                    Transmettez ces informations au représentant.
                </div>
                <div class="space-y-3">
                    @if($compte_has_email)
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="col-span-2">
                            ...
                            <input wire:model="ifu" type="text" maxlength="9"
                                class="w-full border rounded-xl px-4 py-2.5 focus:outline-none text-sm font-mono uppercase bg-white"
