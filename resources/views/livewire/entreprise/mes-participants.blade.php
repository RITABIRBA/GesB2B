<div>
    ...
    <div class="bg-white rounded-xl shadow p-6 mb-6 border-l-4" style="border-color: #007A3D;">
        <div class="flex items-center gap-4 mb-4">
            <div class="w-12 h-12 rounded-xl flex items-center justify-center"
                style="background-color: #e6f4ed;">
                <i class="fa-solid fa-user-clock text-xl" style="color: #007A3D;"></i>
            </div>
            <div>
                ...
                <p class="text-sm text-gray-400 mt-0.5">
                    {{ $demandesEnAttente->count() }} participant(s) veulent rejoindre votre entreprise
                </p>
            </div>
        </div>
        ...
        <table class="w-full text-left">
            <thead style="background-color: #f8f9fa;">
                <tr class="border-b">
                    ...
                    <th class="px-6 py-4 text-gray-500 font-semibold text-sm">Adhésion</th>
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50 transition">
                    ...
                    {{-- Statut adhésion --}}
                    <td class="px-6 py-4">
                        @if($participant->statut_adhesion == 'en_attente')
                        ...
                        @elseif($participant->statut_adhesion == 'accepte')
                            <span class="text-xs px-2 py-1 rounded-full bg-green-100 text-green-700 font-medium">
                                <i class="fa-solid fa-circle-check mr-1"></i> Accepté
                            </span>
                        @elseif($participant->statut_adhesion == 'rejete')
                        ...
                        @else
                            <span class="text-xs px-2 py-1 rounded-full bg-blue-100 text-blue-700 font-medium">
                                <i class="fa-solid fa-link mr-1"></i> Direct
                            </span>
                        @endif
                    </td>
    ...
    <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-y-auto max-h-[90vh]">
            ...
            <div class="p-8">
                ...
                <div class="mb-6">
                    <p class="text-sm font-semibold text-gray-700 mb-2">Participants concernés :</p>
                ...
                <div>
                    <label class="block text-gray-600 text-sm font-medium mb-1.5">Numéro de téléphone *</label>
                ...
                <div>
                    <label class="block text-gray-600 text-sm font-medium mb-1.5">Code OTP *</label>
