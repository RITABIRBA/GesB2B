...
class GestionEntreprises extends Component
{
    ...
    public array $pays_liste = [
        ...
        'Angola', 'Cameroun', 'Congo', 'Gabon', 'Tchad',
        'Éthiopie', 'Kenya', 'Madagascar', 'Mozambique', 'Ouganda', 'Rwanda',
        'Tanzanie', 'Zimbabwe', 'Algérie', 'Égypte', 'Libye', 'Maroc', 'Tunisie',
        'Afrique du Sud', 'Botswana', 'Namibie',
        'Allemagne', 'Belgique', 'Espagne', 'France', 'Italie',
        'Pays-Bas', 'Portugal', 'Royaume-Uni', 'Russie', 'Suisse', 'Turquie',
        'Brésil', 'Canada', 'États-Unis', 'Mexique',
        'Arabie Saoudite', 'Chine', 'Émirats arabes unis', 'Inde', 'Japon',
        'Australie', 'Autre',
    ];

    public array $villes_par_pays = [
        'Burkina Faso'   => ['Ouagadougou', 'Bobo-Dioulasso', 'Koudougou', 'Banfora', 'Ouahigouya', 'Kaya', 'Tenkodogo', 'Autre'],
        'Bénin'          => ['Cotonou', 'Porto-Novo', 'Parakou', 'Abomey-Calavi', 'Autre'],
        'Côte d\'Ivoire' => ['Abidjan', 'Bouaké', 'Daloa', 'Yamoussoukro', 'Autre'],
        'Mali'           => ['Bamako', 'Sikasso', 'Mopti', 'Ségou', 'Autre'],
        ...
        'France'         => ['Paris', 'Marseille', 'Lyon', 'Toulouse', 'Autre'],
        'Autre'          => ['Autre'],
    ];
    ...
    public function getVillesRepProperty(): array
    {
        return $this->villes_par_pays[$this->rep_pays] ?? ['Autre'];
    }
    ...
    public function valider(int $id): void
    {
        ...
        if ($representant) {
            Notification::create([
                ...
                'contenu'        => "✅ Votre entreprise {$entreprise->nom} a été validée par la supervision.",
    ...
    {
        return view('livewire.superviseur.gestion-entreprises', [
            ...
            'villesRep'         => $this->villesRep,
            'evenements'        => Evenement::orderBy('nom')->get(),
        ])->layout('layouts.superviseur', ['title' => 'Gestion des Entreprises']);
    }
}