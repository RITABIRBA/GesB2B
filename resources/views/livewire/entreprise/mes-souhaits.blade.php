<div>
    ...
    {{-- Blocage si le représentant n'a pas de profil participant --}}
    @if(!$participant)
    <div class="bg-orange-50 border border-orange-200 rounded-xl p-8 text-center">
        ...
        <p class="text-gray-500 text-sm mb-4">
            Vous devez d'abord compléter votre inscription à un événement.
        </p>
    ...
    <div class="bg-orange-50 border border-orange-200 rounded-xl p-8 text-center">
        ...
        <p class="text-gray-500 text-sm mb-4">
            Vous n'avez pas activé la participation aux rendez-vous d'affaires lors de votre inscription.
        </p>
    ...
    {{-- En-tête avec nom de l'événement et barre de progression --}}
    ...
    {{-- Tableau récapitulatif des souhaits avec gestion des priorités --}}
    @if($souhaits->count() > 0)
