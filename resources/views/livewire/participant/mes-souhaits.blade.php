<div>
    ...
    <div class="bg-orange-50 border border-orange-200 rounded-xl p-8 text-center">
        ...
        <a href="{{ route('participant.profil') }}" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-white font-medium" style="background-color: #007A3D;">
    ...
    <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-8 text-center">
        ...
        <a href="{{ route('participant.inscription') }}" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-white font-medium" style="background-color: #C8102E;">
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-xl p-8 text-center">
        ...
        <a href="{{ route('participant.dashboard') }}" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-white font-medium" style="background-color: #007A3D;">
