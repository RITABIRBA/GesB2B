            ...
            <div class="p-8 space-y-5">
                ...
                <div class="bg-gray-50 rounded-xl p-5 border border-gray-200">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <label class="cursor-pointer">
                            <input type="radio" wire:model.live="type_evenement"
                                value="avec_b2b" class="hidden peer">
                            <div class="p-4 border-2 rounded-xl transition text-center
                                peer-checked:border-green-500 peer-checked:bg-green-50
                                hover:bg-gray-50 border-gray-200">
                                <i class="fa-solid fa-handshake text-2xl mb-2 block"
                                    style="color: #007A3D;"></i>
                                <p class="font-bold text-gray-800 text-sm">Avec B2B</p>
                                <p class="text-xs text-gray-400 mt-1">
                                    Souhaits, RDV, planning automatique
                                </p>
                            </div>
                        </label>
                        <label class="cursor-pointer">
                            <input type="radio" wire:model.live="type_evenement"
                                value="sans_b2b" class="hidden peer">
                            <div class="p-4 border-2 rounded-xl transition text-center
                                ...
                                <p class="text-xs text-gray-400 mt-1">
                                    Inscription simple, ouvert à tous
                                </p>
                            </div>
                        </label>
                    </div>
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="flex gap-6 mb-3">
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="radio" wire:model.live="utiliser_nouveau_type"
                                        value="" class="accent-green-700">
                                    <span class="text-sm text-gray-600">Catégorie existante</span>
                                </label>
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="radio" wire:model.live="utiliser_nouveau_type"
                                        value="1" class="accent-red-600">
                ...
                <div class="bg-green-50 rounded-xl p-5 border border-green-200">
                    ...
                    <p class="text-xs text-green-600 mt-2">
                        ...
                        Passé la date de clôture, plus aucune inscription ne sera possible.
                    </p>
                </div>
                ...
                {{-- SECTION : Config B2B (uniquement si avec_b2b) --}}
                ...
                <div class="bg-gray-50 rounded-xl p-5 border border-gray-200">
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-3">
                        <label class="cursor-pointer">
                            <input type="radio" wire:model.live="type_paiement"
                                value="gratuit" class="hidden peer">
                        ...
                        <label class="cursor-pointer">
                            <input type="radio" wire:model.live="type_paiement"
                                value="payant" class="hidden peer">
                            <div class="p-4 border-2 rounded-xl text-center transition
                ...
                <div class="bg-yellow-50 rounded-xl p-5 border border-yellow-200">
                    ...
                    <div class="text-center py-4 text-gray-400 text-sm">
                        ...
                        Aucun type de stand défini.
                        Cliquez sur "Ajouter un type" pour en créer.
                    </div>
                    @else
                    <div class="space-y-2">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-3 text-xs text-gray-500 mt-0.5 flex-wrap">
                                        {{-- ✅ NOUVEAU : Affichage de la quantité --}}
                    ...
                    {{-- ✅ NOUVEAU : Total calculé automatiquement --}}
    ...
    <div class="fixed inset-0 bg-black/60 flex items-center justify-center z-[60] p-4">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    <label class="block text-gray-600 text-sm font-medium mb-1.5">
                        Nom du standing * <span class="text-gray-400 font-normal">(ex: Standard, Premium, VIP)</span>
                    </label>
                    <input wire:model="ts_standing" type="text"
                        class="w-full border rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-red-300 text-sm"
                        placeholder="Ex: Standard">
                    @error('ts_standing') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>

                {{-- ✅ NOUVEAU : Nombre de stands pour ce standing --}}
                <div>
                    <label class="block text-gray-600 text-sm font-medium mb-1.5">
                    ...
                    <input wire:model="ts_quantite" type="number" min="1" max="200"
                        ...
                        placeholder="Ex: 10">
                    <p class="text-xs text-gray-400 mt-1">
                        Combien de stands de ce type seront générés (ex: 10 stands Standard, 5 Premium, 2 VIP).
                    </p>
                ...
                <div>
                    ...
                    <div class="bg-green-50 border border-green-200 rounded-xl p-3 text-xs text-green-700">
                        ...
                        Ce type de stand sera gratuit pour les participants qui y sont assignés.
                    </div>
                    @endif
                </div>
