<div>
    ...
    {{-- Description des types de stands --}}
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5">
            <div class="flex items-center gap-3 mb-3">
                <div class="w-10 h-10 rounded-xl flex items-center justify-center"
                    ...
                    <i class="fa-solid fa-store text-xl" style="color: #007A3D;"></i>
                </div>
                <div>
            ...
            <ul class="space-y-1 text-xs text-gray-500">
                <li><i class="fa-solid fa-check text-green-500 mr-1"></i> Espace de base 9m²</li>
                <li><i class="fa-solid fa-check text-green-500 mr-1"></i> 1 table + 2 chaises</li>
                <li><i class="fa-solid fa-check text-green-500 mr-1"></i> Électricité incluse</li>
                <li><i class="fa-solid fa-xmark text-red-400 mr-1"></i> Internet non inclus</li>
                <li><i class="fa-solid fa-xmark text-red-400 mr-1"></i> Décoration non incluse</li>
            </ul>
        </div>
        ...
        <div class="bg-white rounded-xl border border-blue-200 p-5">
            <div class="flex items-center gap-3 mb-3">
                ...
                <div>
                    ...
                    <span class="text-xs px-2 py-0.5 rounded-full text-white font-medium bg-blue-600">
                        Populaire
                    </span>
                </div>
            </div>
            <ul class="space-y-1 text-xs text-gray-500">
                <li><i class="fa-solid fa-check text-green-500 mr-1"></i> Espace moyen 16m²</li>
                <li><i class="fa-solid fa-check text-green-500 mr-1"></i> 2 tables + 4 chaises</li>
                <li><i class="fa-solid fa-check text-green-500 mr-1"></i> Électricité incluse</li>
                <li><i class="fa-solid fa-check text-green-500 mr-1"></i> Internet inclus</li>
                <li><i class="fa-solid fa-check text-green-500 mr-1"></i> Décoration de base</li>
            </ul>
        </div>
        ...
        <div class="bg-white rounded-xl border border-yellow-200 p-5">
            <div class="flex items-center gap-3 mb-3">
                ...
                <div>
                    <p class="font-bold text-gray-800">VIP</p>
                    <span class="text-xs px-2 py-0.5 rounded-full text-white font-medium bg-yellow-500">
                        Prestige
                    </span>
                </div>
            </div>
            <ul class="space-y-1 text-xs text-gray-500">
                <li><i class="fa-solid fa-check text-green-500 mr-1"></i> Grand espace 25m²</li>
                <li><i class="fa-solid fa-check text-green-500 mr-1"></i> Mobilier complet</li>
                <li><i class="fa-solid fa-check text-green-500 mr-1"></i> Électricité + Internet</li>
                <li><i class="fa-solid fa-check text-green-500 mr-1"></i> Décoration premium</li>
                <li><i class="fa-solid fa-check text-green-500 mr-1"></i> Accès salon VIP</li>
            </ul>
        </div>
    ...
    <div>
        ...
        <div class="mb-6">
            {{-- Header événement --}}
            <div class="flex items-center justify-between mb-3 p-3 rounded-xl"
                style="background-color: #e6f4ed;">
            ...
            {{-- Prix de l'événement --}}
            @if($evenement && ($evenement->prix_stand_standard || $evenement->prix_stand_premium || $evenement->prix_stand_vip))
            <div class="flex gap-3 mb-3 flex-wrap">
                <span class="text-xs px-3 py-1 rounded-full font-medium text-white" style="background-color: #007A3D;">
                    ...
                    Standard : {{ number_format($evenement->prix_stand_standard, 0, ',', ' ') }} FCFA
                </span>
                <span class="text-xs px-3 py-1 rounded-full font-medium text-white bg-blue-600">
                    <i class="fa-solid fa-gem mr-1"></i>
                    Premium : {{ number_format($evenement->prix_stand_premium, 0, ',', ' ') }} FCFA
                </span>
                <span class="text-xs px-3 py-1 rounded-full font-medium text-white bg-yellow-500">
                    <i class="fa-solid fa-star mr-1"></i>
                    VIP : {{ number_format($evenement->prix_stand_vip, 0, ',', ' ') }} FCFA
                </span>
            </div>
            @endif
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
                ...
                <div class="bg-white rounded-xl shadow p-4 text-center border-2
                    ...
                    transition">
                    <div class="w-10 h-10 rounded-xl flex items-center justify-center text-white font-bold text-sm mx-auto mb-2"
                        style="background-color: {{ $reservationFermee ? '#9ca3af' : '#007A3D' }}">
                        {{ $stand->numero_stand }}
                    </div>
                    <p class="text-xs text-gray-500 mb-1">{{ $stand->superficie }} m²</p>

                    @if($stand->standing == 'vip')
                    <span class="text-xs px-2 py-0.5 rounded-full text-white bg-yellow-500 font-medium block mb-1">
                        <i class="fa-solid fa-star mr-0.5"></i> VIP
                    </span>
                    @elseif($stand->standing == 'premium')
                    <span class="text-xs px-2 py-0.5 rounded-full text-white bg-blue-600 font-medium block mb-1">
                        <i class="fa-solid fa-gem mr-0.5"></i> Premium
                    </span>
                    @else
                    <span class="text-xs px-2 py-0.5 rounded-full text-white font-medium block mb-1"
                        style="background-color: #007A3D;">
                    ...
                    @if($prixStand > 0)
                    <p class="text-xs font-bold mb-2" style="color: #C8102E;">
                        {{ number_format($prixStand, 0, ',', ' ') }} F
                    </p>
                    @else
                    <p class="text-xs text-green-600 mb-2 font-medium">Gratuit</p>
                    @endif
                    ...
                    <button wire:click="reserverStand({{ $stand->id }})"
                        wire:confirm="Réserver le Stand N°{{ $stand->numero_stand }} pour {{ number_format($prixStand, 0, ',', ' ') }} FCFA ?"
                        class="w-full py-1.5 rounded-lg text-xs text-white font-medium transition hover:opacity-90"
                        style="background-color: #C8102E;">
