...
<head>
    ...
    <title>{{ $title ?? 'GesB2B' }} — Traducteur</title>
        ...
        <div class="p-6 text-center border-b border-green-800">
            <div class="flex items-center justify-center gap-2 mb-1">
                <div class="w-8 h-8 rounded-full flex items-center justify-center text-white font-bold text-sm"
                    style="background-color: #C8102E;">T</div>
                <h1 class="text-xl font-bold text-white">GesB2B</h1>
            </div>
            <p class="text-xs text-green-300 mt-1">Espace Traducteur</p>
        </div>
        ...
        <div class="p-4 border-t border-green-800">
            <div class="flex items-center gap-3 px-3 py-2 mb-2">
                ...
                <div>
                    ...
                    <p class="text-green-300 text-xs">Traducteur</p>
                </div>
            </div>
