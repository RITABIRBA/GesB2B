<div>
        ...
        <div class="rounded-xl px-6 py-5 mb-6 flex items-center justify-between gap-4 flex-wrap"
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-green-200">L'inscription de votre entreprise est désormais complète.</p>
                </div>
            </div>
            @if($recuPaiement)
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl px-6 py-5 mb-6 flex items-center justify-between gap-4 flex-wrap">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-blue-600">Sélectionnez les entreprises que vous souhaitez rencontrer.</p>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div class="bg-white rounded-xl shadow p-6 flex items-center gap-4 border-l-4 hover:shadow-lg transition"
            ...
            <div>
                ...
                <p class="text-xs text-orange-500 mt-1">{{ $demandesEnAttente }} demande(s) en attente</p>
                @endif
            </div>
        </div>
        <div class="bg-white rounded-xl shadow p-6 flex items-center gap-4 border-l-4 hover:shadow-lg transition"
        ...
        <div class="bg-white rounded-xl shadow p-6 flex items-center gap-4 border-l-4 hover:shadow-lg transition"
            ...
            <div class="w-14 h-14 rounded-full flex items-center justify-center text-2xl" style="background-color: #fef3e2;">
    ...
    {{-- ============================================================
         ÉVÉNEMENTS DISPONIBLES — AVEC TOUS LES DÉTAILS
    ============================================================ --}}
    <div class="bg-white rounded-xl shadow p-6 mb-6">
            ...
            <div class="p-8">
                ...
                <div class="space-y-3 mb-5">
                    <button type="button" wire:click="$set('mode_paiement', 'orange_money')"
                        ...
                        <i class="fa-solid {{ $mode_paiement === 'orange_money' ? 'fa-circle-check text-orange-500' : 'fa-chevron-right text-gray-400' }} ml-auto"></i>
                    </button>
                    <button type="button" wire:click="$set('mode_paiement', 'moov_money')"
                        ...
                        <i class="fa-solid {{ $mode_paiement === 'moov_money' ? 'fa-circle-check text-blue-500' : 'fa-chevron-right text-gray-400' }} ml-auto"></i>
                    </button>
                    <button type="button" wire:click="$set('mode_paiement', 'cheque')"
                        ...
                        <i class="fa-solid {{ $mode_paiement === 'cheque' ? 'fa-circle-check text-red-500' : 'fa-chevron-right text-gray-400' }} ml-auto"></i>
                    </button>
                </div>
                ...
                <button wire:click="payerParCheque" wire:loading.attr="disabled" wire:loading.class="opacity-70 cursor-not-allowed"
                    ...
                    style="background-color: #C8102E;">
                    <span wire:loading.remove wire:target="payerParCheque"><i class="fa-solid fa-paper-plane mr-1"></i> Soumettre le paiement</span>
                    <span wire:loading wire:target="payerParCheque"><i class="fa-solid fa-spinner fa-spin mr-1"></i> Envoi...</span>
                </button>
                @else
                <div class="mb-5">
                ...
                <div class="bg-orange-50 border border-orange-200 rounded-xl p-3 mb-5 text-xs text-orange-700 flex items-start gap-2">
                    ...
                    Composez <strong>*144*4*6#</strong> sur votre téléphone Orange pour générer votre OTP.
                </div>
                @endif
                ...
                <div class="flex gap-3">
                    ...
                    <button wire:click="confirmerOtp" wire:loading.attr="disabled" wire:loading.class="opacity-70 cursor-not-allowed"
                        ...
                        style="background-color: #007A3D;">
                        <span wire:loading.remove wire:target="confirmerOtp"><i class="fa-solid fa-check mr-1"></i> Confirmer</span>
                        <span wire:loading wire:target="confirmerOtp"><i class="fa-solid fa-spinner fa-spin mr-1"></i> Traitement...</span>
                    </button>
                </div>
                @endif
            </div>
