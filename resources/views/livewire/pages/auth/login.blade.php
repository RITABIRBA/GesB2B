...
<div class="min-h-screen flex" style="background-color: #f8f9fa;">
    ...
    <div class="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 text-white"
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-2xl font-bold">Business Forum</h1>
        ...
        <div>
            <h2 class="text-4xl font-bold mb-4 leading-tight">
                Plateforme de gestion des forums économiques
            </h2>
            ...
            <div class="space-y-4">
                @foreach([
                    ['fa-handshake',  'Gestion des rendez-vous B2B'],
                    ['fa-calendar',   'Organisation des forums économiques'],
                    ['fa-building',   'Mise en relation des entreprises'],
                    ['fa-id-badge',   'Gestion des badges et inscriptions'],
                    ['fa-users',      'Ouvert aux particuliers et étudiants'],
                ] as [$icon, $label])
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-green-100">{{ $label }}</span>
                </div>
                @endforeach
            </div>
        </div>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="lg:hidden flex items-center gap-3 mb-8 justify-center">
                <img src="{{ asset('images/logo-ccibf.png') }}"
                    alt="CCI-BF" class="w-12 h-12 object-contain rounded-xl">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Business Forum</h1>
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-500 mt-2">Bienvenue sur Business Forum CCI-BF</p>
            </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input wire:model="form.password"
                            ...
                            placeholder="••••••••"
                            class="w-full border border-gray-300 rounded-xl px-4 py-3 pr-12 focus:outline-none focus:ring-2 focus:ring-green-500 text-sm">
                        <button type="button"
            ...
            <div class="bg-gray-50 border border-gray-200 rounded-2xl p-5">
                ...
                <p class="text-xs text-gray-500 mb-3">
                    Pour les participants ayant reçu un code d'accès.
                </p>
            ...
            {{-- Liens d'inscription compacts --}}
            <div class="text-center mt-6 pt-5 border-t border-gray-100">
                <p class="text-sm text-gray-500 mb-2">Pas encore de compte ?</p>
                <div class="flex items-center justify-center gap-4 text-sm">
                    <a href="{{ route('inscription.participant') }}"
                        class="font-semibold hover:underline flex items-center gap-1.5"
                        style="color: #007A3D;">
            ...
            <p class="text-center text-xs text-gray-400 mt-6">
                © {{ date('Y') }} CCI-BF — Business Forum Platform
            </p>
        </div>
    </div>
