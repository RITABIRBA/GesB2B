    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden max-w-3xl mx-auto">
        ...
        <div class="p-8 space-y-6">
            ...
            <div>
                ...
                <p class="text-xs text-gray-400 mb-3">Sélectionnez les jours où vous sera disponible pour les RDV B2B.</p>
            ...
            <a href="{{ route('entreprise.souhaits') }}" class="block text-center text-sm text-gray-400 hover:text-gray-600 mt-2">
