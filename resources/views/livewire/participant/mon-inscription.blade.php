...
<div>
    ...
    @if(session('info'))
    <div class="bg-blue-100 border border-blue-300 text-blue-700 px-6 py-4 rounded-xl mb-6 flex items-center gap-3">
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-y-auto max-h-[90vh]">
            ...
            <div class="p-8">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input wire:model="telephone_paiement" type="text"
                            class="w-full border rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-orange-300 text-lg text-center font-mono"
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-xl p-3 text-xs text-blue-700">
                        <i class="fa-solid fa-circle-info mr-1"></i>
                        @if($mode_paiement == 'orange_money')
                        Un code OTP vous sera envoyé. Composez ensuite
                        <strong>*144*6*[votre numéro]#</strong> pour confirmer.
                        @else
                        Un code OTP vous sera envoyé. Composez ensuite
                        <strong>*155*1*[votre numéro]#</strong> pour confirmer.
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-orange-50 border border-orange-200 rounded-xl p-4 mb-4 text-center">
                    ...
                    <p class="font-mono font-bold text-orange-700 text-lg">
                        @if($mode_paiement == 'orange_money')
                            *144*6*{{ $telephone_paiement }}#
                        @else
                            *155*1*{{ $telephone_paiement }}#
                        @endif
                    </p>
                </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input wire:model="otp_saisi" type="text" maxlength="6"
                            class="w-full border rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-300 text-2xl text-center font-mono tracking-widest"
