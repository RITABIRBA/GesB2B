            ...
            <div class="p-8">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input wire:model.live="secteur_autre" type="text" class="w-full mt-2 border rounded-xl px-4 py-2.5 focus:outline-none text-sm" placeholder="Précisez...">
                        @endif
            ...
            <div class="p-8">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        {{-- ✅ CORRECTION : champ de saisie libre si "Autre" est re-sélectionné ici --}}
                        @if($secteur_activite === 'Autre')
                        <div class="mt-2" wire:key="secteur-autre-wrapper-b2b-entreprise">
                            <input wire:model.live="secteur_autre" type="text"
                            ...
                            @error('secteur_autre') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                        </div>
                        @endif
                    ...
                    <div>
                        ...
                        <div class="bg-orange-50 border border-orange-200 rounded-xl p-4 mb-4 flex items-start gap-3">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-orange-700">Cochez les jours où le représentant NE SERA PAS là</p>
                                <p class="text-xs text-orange-600 mt-1">
                                    Par défaut, le représentant est considéré présent tous les jours de l'événement.
                                    Si vous savez qu'il sera absent certains jours, cochez-les ici.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                            <p class="text-sm text-blue-700">
                                ...
                                @if(count($joursEvenement) == 1)
                                Événement sur 1 seul jour — le représentant sera automatiquement présent ce jour.
                                @else
                                Sélectionnez un événement à l'étape 1 pour indiquer les disponibilités.
                                @endif
                            </p>
                        </div>
                        @endif
                ...
                <div class="space-y-3 mb-6">
                    ...
                    <div class="bg-indigo-50 border border-indigo-200 rounded-xl p-4">
                        ...
                        <div class="space-y-3 text-sm">
                            ...
                            @if(count($joursEvenement) > 1)
                            <div>
                                <span class="text-gray-400 text-xs block mb-1">Disponibilité du représentant</span>
